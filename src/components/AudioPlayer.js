...
import { MediaFavorites, Settings } from '../context'
...
function AudioPlayer(props) {
 ...
 return (
  ...
  >
   ...
   <div
    style={{
     fontSize: calculateFontSize(audio.text.split(' ').length),
     textAlign: 'justify',
   ...
   <div style={{ width: '100%' }}>
    ...
    >
     ...
     <IonButton
      ...
      style={{ height: '36px', width: '48px' }}
      onClick={() => {
       window.location.assign(audio.url)
      }}
     >
   ...
   >
    <div>
     <div style={{ textAlign: 'center', marginTop: '10px' }}>
      Audio Speed Rate {audi.current ? `(${audi.current.playbackRate}x)` : null}
     </div>
     <IonList>
      {[
