...
function Search(props) {
 ...
 return (
  ...
  >
   <p style={{ margin: '10px' }}>
    The search feature is still in development. Please use our comprehensive
    search page{' '}
    <a href="https://vanipedia.org/wiki/Special:VaniSearch?&tab=text">here</a>{' '}
   </p>
   {!searchLoaded ? (
    <div
     style={{
           ...
           <IonItem
            onClick={() => {
             if (key.startsWith('Lectures'))
              ...
              history.push(
               '/purports/' + val['name'] + '?hl=' + text.replace(/\s+/g, '|')
              )
            }}
           >
